...
public class Opponent implements PlayerProfile{
    ...
    public Opponent selectRandomOpponent() {
        ...
        if(skipCount>=6){  //If skipped more than 5 times return whitewolf
            System.out.println("Cannot skip further. Player 'whitewolf' is automatically selected for the challenge.");
            selectedOpponent = opponentUsernames.get("whitewolf");
